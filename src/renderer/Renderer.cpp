	...
	namespace Rendering
	{
		...
		void Renderer::SetupRenderPipeline()
		{
...

			{
				...
				BasePassVS.CompileFromFile(this->GetCompiler(), "BasePass.vs.hlsl");

				D3D12::Shader BasePassPS;
				BasePassPS.CompileFromFile(this->GetCompiler(), "BasePass.ps.hlsl");
		...
		void Renderer::InitPrimitiveBatchPipeline()
		{
			...
			D3D12::Shader PassVS;
			PassVS.CompileFromFile(this->GetCompiler(), "PrimitiveBatch.vs.hlsl");

			D3D12::Shader PassPS;
			PassPS.CompileFromFile(this->GetCompiler(), "PrimitiveBatch.ps.hlsl");
